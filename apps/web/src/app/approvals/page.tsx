        ...
        {approvals.length === 0 ? (
          ...
          >
            ...
            <p style={{ fontSize: '0.875rem', margin: 0 }}>
              All caught up! There are no items awaiting your review.
            </p>
          </div>
        ) : (
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
            <thead>
              <tr style={{ borderBottom: '1px solid #e5e7eb', background: '#f9fafb' }}>
                {['Entity', 'Rule Name', 'Current Step', 'Status', 'Created', 'Actions'].map((col) => (
                  <th
                    key={col}
                    style={{
            ...
            <tbody>
              {approvals.map((approval, idx) => (
                <tr
                  key={approval.id}
                  style={{
                    borderBottom: idx < approvals.length - 1 ? '1px solid #f3f4f6' : undefined,
                  }}
                >
                  <td style={{ padding: '0.875rem 1rem' }}>
                    ...
                    <div style={{ color: '#9ca3af', fontSize: '0.75rem', fontFamily: 'monospace', marginTop: '0.125rem' }}>
                      {truncateId(approval.approvableId)}
                    </div>
                  </td>
